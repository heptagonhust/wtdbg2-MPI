...
EXTERN_C void bitpush_kbm(KBM *kbm, char *tag, int taglen, u8i *seqs, u8i seqoff,                               u4i seqlen);
...
EXTERN_C void split_FIXP_kmers_kbm(BaseBank *rdseqs, u8i offset, u4i length,                                        u1i ksize, u1i psize, u4i kmod, kmeroffv *rs[2]);
...
EXTERN_C void query_index_kbm(KBMAux *aux, char *qtag, u4i qidx, BaseBank *rdseqs,                                   u8i seqoff, u4i seqlen);
EXTERN_C void print_exists_index_kbm(KBM *kbm, char *qtag, BaseBank *rdseqs,                                          u8i seqoff, u4i seqlen, kmeroffv *kmers[2],                                          FILE *out);
...
EXTERN_C void print_hit_kbm(KBM *kbm, char *qtag, u4i qlen, kbm_map_t *hit,                                 BitsVec *cigars, String *_str, FILE *out);
...
EXTERN_C int simple_chain_all_maps_kbm(kbm_map_t *srcs, u4i size,                                            BitsVec *src_cigars, kbm_map_t *dst,                                            BitsVec *dst_cigars, float max_aln_var);
